const e=document.getElementById("mobile-navbar"),t=document.getElementById("desktop-navbar");e.classList.add("h-[70px]","w-screen","glassmorphism","fixed","bottom-0","z-[50]","lg:hidden");e.innerHTML=`
  <ul
...
`;t.classList.add("w-screen","h-auto","bg-black","hidden","lg:flex","text-text","py-5","fixed","top-0","z-[55]");t.innerHTML=`
